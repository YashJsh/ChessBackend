...
export class GameManager {
  private activeGames: Map<string, ChessBoard>;
  ...
  public PairPlayers(player1: Player, player2: Player) {
    ...
    const game = new ChessBoard(player1, player2);
  ...
  private gameCommunication(player1: Player, player2: Player) {
